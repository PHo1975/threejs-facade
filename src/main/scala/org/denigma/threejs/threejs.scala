...
class Float32BufferAttribute( data:js.Any, itemSize:Double, normalized:Boolean=true ) extends BufferAttribute(data,itemSize)
...
@js.native
trait RaycastThreshold extends js.Object{
  var threshold:Int=1;
}
...
trait RaycasterParameters extends js.Object {
  ...
  var Line: RaycastThreshold = js.native
}
...
class LineDashedMaterial(parameters: LineDashedMaterialParameters = js.native) extends LineBasicMaterial {
  var scale: Double = js.native
  var dashSize: Double = js.native
  var gapSize: Double = js.native
...
class LineSegments(ngeometry:Geometry=js.native,nmaterial:LineBasicMaterial=js.native) extends Line(ngeometry,nmaterial)
...
class ShapeBufferGeometry(shapes: js.Array[Shape] = js.native,curveSegments:Int=12) extends BufferGeometry
...
class EdgesGeometry(geometry:Geometry,thresholdAngle:Double) extends BufferGeometry
